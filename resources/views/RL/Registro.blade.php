...
<body class="fondo">
    <div class="base">
        <div class=" nav_homesite">
            <div> <!--Icono del logo de la aplicación-->
                <a href="{{asset('/')}}"  class="nav_link"><p style="color: aliceblue;">Preguntados</p></a>
            </div>
        ...
        <div style="height: 100vh;" class="d-flex justify-content-center align-items-center">
            <div class="d-flex" style=" background-color: rgb(255, 255, 255);">
                        ...
                        <form action="">
                            ...
                            <div>
                                <div class="d-flex justify-content-center" style="padding-top: 30px;"><!--Caja de boton de registrarme-->
                                    <a href="{{asset('RL/Login')}}"><input type="button" value="Registrarme"  class="btn btn-danger btn-outline-secondary btn-lg"  style="color: rgb(0, 0, 0)" >    
                                </div>
                                <div class="d-flex justify-content-center" style="padding-top: 50px;"><!--Iniciar sesion-->
                                    <p class="d-flex " style="display: flex;">¿Tienes una cuenta? <a
                                        href="{{asset('RL/Login')}}">Inicia sesión</a> </p>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="col-lg-6 card box_main_img  d-flex justify-content-center align-items-center box_main_form" style="background-color: aqua;"> <!--seccion imagen-->
                        <img src="{{asset('images/RegistroComite.jpg')}}" alt="" width="100%" height="100%">
