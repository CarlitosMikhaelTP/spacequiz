    ...
    <div class="base">
        ...
        <div class=" nav_homesite">
            ...
            <div class="nav_list">
                <!--Div más info-->
                <div class="box_link">
                    <a href="{{asset('OpcionesLanding/Masinformacion')}}" class="nav_link">
                        <p class="nav_text">Mas info</p>
                    </a>
                </div>
                <!--Div de ¿cómo jugar?-->
                <div class="box_link">
                    <a href="{{asset('OpcionesLanding/ComoJugar')}}" class="nav_link">
                        <p class="nav_text">Cómo jugar?</p>
                    </a>
                </div>
                <!--Div de iniciar sesión-->
                <div class="box_link">
                        <a href="{{asset('RL/Login')}}" class="nav_link">
                            <p class="nav_text"> Iniciar sesión </p>
                        </a>
                        <p class="nav_text">/</p>
                        <a href="{{asset('RL/RegistroTipo')}}" class="nav_link">
        ...
        <div class="h-100 d-flex justify-content-center align-items-center">
            ...
            <div class="main_login">
                ...
                <div class="col-6 card box_main_img rounded-4">
                    <img src="{{asset('images/perfilAstronauta.jpg')}}" class="rounded-4" alt="" width="100%" height="100%">
                        ...
                        <div class="h-75">
                            ...
                            <form action="">
                                ...
                                <div class="text-center login_div_input">
                                    <a href="{{asset('Estudiante/MenuEstudiante')}}"><input type="button" value="IngresarE" class="login_btn"></a>
                                </div>
                                <div class="text-center login_div_input">
                                    <a href="{{asset('Docente/MenuDocente')}}"><input type="button" value="IngresarP" class="login_btn"></a>
                                </div>
                                <div class="text-center login_div_input">
                                    <a href="{{asset('Comite/ComitePanel')}}"><input type="button" value="IngresarC" class="login_btn"></a>
                                </div>
                            </form>
                        </div>
                        <!--Div para el texto de registrarse si no tienes cuenta-->
                        <div class="d-flex align-items-end justify-content-center">
                            <a  class="d-flex texto_enlace" href="{{asset('RL/RegistroTipo')}}">
